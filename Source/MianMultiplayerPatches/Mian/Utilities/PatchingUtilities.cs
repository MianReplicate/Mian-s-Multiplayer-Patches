// Massive thanks to Multiplayer Compatibility for providing this library through the MIT License! I love yall sm 💖
    ...
    static class PatchingUtilities
    {
        ...
        internal static void PatchSystemRand(MethodBase method, bool patchPushPop = true)
        {
            ...
            if (patchPushPop)
                ...
                Constants.Harmony.Patch(method, transpiler: transpiler);
        }
        ...
        {
            Constants.Harmony.Patch(method,
